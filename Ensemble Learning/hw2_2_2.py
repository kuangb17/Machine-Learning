...
for i in obj_dic:
    obj_dic[i] = statistics.median([row[i] for row in train_data]) # binary quantization of numerical attributes
...
for row in test_data:
    for i in obj_dic:
        if row[i] >= obj_dic[i]:
            ...
            row[i] = 'no'  # binary quantization of numerical attributes
...
for i in Attr_dict:
    keys.append(i)
# print(keys)
Attr_set = set(keys)  # create a set for all attrs
# print(Attr_set)
